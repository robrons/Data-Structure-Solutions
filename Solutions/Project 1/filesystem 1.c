...
fsNode * setChild(fsNode * fn, char * locnm){
if(fn==NULL){
fsNode * fn = newfsNode(locnm,"D");
return fn;
}
...
{
 fn->nextsibling = setChild(fn->nextsibling, locnm);
}
else {
return NULL;
}
...
fn->firstchild = setChild(fn->firstchild, locnm);
fn->firstchild->parent = fn;
